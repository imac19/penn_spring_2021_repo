...
lidar_example = load_lidar_data('data/train/train_lidar0.mat')
joint_example = load_joint_data('data/train/train_joint0.mat')
# =============================================================================
# show_lidar(lidar_example)
# =============================================================================

find_joint_t_idx_from_lidar = lambda t: np.argmin(np.abs(joint_example['t']-t))

find_joint_t_idx_from_lidar(lidar_example[1]['t'])

lidar_t = lidar_example[0].get('t')

joint_t = joint_example['t'][1000]
